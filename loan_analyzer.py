...
#The average loan amont from the list is 550.
...
# The Remaining months is 9 months.
...
# YOUR CODE HERE!
loan_costs = loan.get("loan_price") 
print(loan_costs)

if present_value >= loan_costs:
    print('The loan is worth to buy.')
else: 
    print('The loan too expensive and not worth the price.')
...
#present_value = future_value / (1 + annual_discount_rate/12) ** remaining_months
present_value = future_value / (1 + annual_discount_rate/12) ** remaining_months
present_value = 1000 / (1 + 0.2/12) ** 12
...
#new_loan_price = inexpensive_loans.append(price["loan_price]"])
...
for row in inexpensive_loans:
    csvwriter.writerrow(row.values())
